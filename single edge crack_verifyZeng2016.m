%FSFS, rectangular, square
clear all
clc
format long
I=5;						%the number of terms in x or y direction
N=3;						%the number of terms of corner functions
a=0.8; 
b=a; 						%a, b are the plate dimensions in x and y directions
h=0.008; 					%thickness
crX=0.2;					%crack length/a
...
for i=1:N
	Lambda(i)=(2*i-1)/2;
	WSA(i)=r^(Lambda(i)+1)*((Lambda(i)*(1-nu)+3+nu)/((Lambda(i)+1)*(nu-1))*cos((Lambda(i)+1)*ThetaA)+cos((Lambda(i)-1)*ThetaA));
	WSB(i)=r^(Lambda(i)+1)*((Lambda(i)*(1-nu)+3+nu)/((Lambda(i)+1)*(nu-1))*cos((Lambda(i)+1)*ThetaB)+cos((Lambda(i)-1)*ThetaB));
	WSC(i)=r^(Lambda(i)+1)*((Lambda(i)*(1-nu)+3+nu)/((Lambda(i)+1)*(nu-1))*cos((Lambda(i)+1)*ThetaC)+cos((Lambda(i)-1)*ThetaC));
	WSD(i)=r^(Lambda(i)+1)*((Lambda(i)*(1-nu)+3+nu)/((Lambda(i)+1)*(nu-1))*cos((Lambda(i)+1)*ThetaD)+cos((Lambda(i)-1)*ThetaD));
	WAA(i)=r^(Lambda(i)+1)*((Lambda(i)*(1-nu)-3-nu)/((Lambda(i)+1)*(nu-1))*sin((Lambda(i)+1)*ThetaA)+sin((Lambda(i)-1)*ThetaA));
	WAB(i)=r^(Lambda(i)+1)*((Lambda(i)*(1-nu)-3-nu)/((Lambda(i)+1)*(nu-1))*sin((Lambda(i)+1)*ThetaB)+sin((Lambda(i)-1)*ThetaB));
	WAC(i)=r^(Lambda(i)+1)*((Lambda(i)*(1-nu)-3-nu)/((Lambda(i)+1)*(nu-1))*sin((Lambda(i)+1)*ThetaC)+sin((Lambda(i)-1)*ThetaC));
	WAD(i)=r^(Lambda(i)+1)*((Lambda(i)*(1-nu)-3-nu)/((Lambda(i)+1)*(nu-1))*sin((Lambda(i)+1)*ThetaD)+sin((Lambda(i)-1)*ThetaD));
end
tic
%%%%%%%%%%%%%%%%%%% stiffness matrix %%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%% diagonal matrices %%%%%%%%%%%%%%%%%%%
...
K3_6=zeros(N,N);
K3_7=zeros(N,N);
K=zeros(I^2+2*N,I^2+2*N);
Vmax1bbA=sym(zeros(N,N));
Vmax1bbB=sym(zeros(N,N));
Vmax1bbC=sym(zeros(N,N));
Vmax1bbD=sym(zeros(N,N));
Vmax2bbA=sym(zeros(N,N));
Vmax2bbB=sym(zeros(N,N));
Vmax2bbC=sym(zeros(N,N));
Vmax2bbD=sym(zeros(N,N));
Vmax3bbA=sym(zeros(N,N));
Vmax3bbB=sym(zeros(N,N));
Vmax3bbC=sym(zeros(N,N));
Vmax3bbD=sym(zeros(N,N));
Vmax4bbA=sym(zeros(N,N));
Vmax4bbB=sym(zeros(N,N));
Vmax4bbC=sym(zeros(N,N));
Vmax4bbD=sym(zeros(N,N));
Vmax5bbA=sym(zeros(N,N));
Vmax5bbB=sym(zeros(N,N));
Vmax5bbC=sym(zeros(N,N));
Vmax5bbD=sym(zeros(N,N));
Vmax6bbA=sym(zeros(N,N));
Vmax6bbB=sym(zeros(N,N));
Vmax6bbC=sym(zeros(N,N));
Vmax6bbD=sym(zeros(N,N));
Vmax7bbA=sym(zeros(N,N));
Vmax7bbB=sym(zeros(N,N));
Vmax7bbC=sym(zeros(N,N));
Vmax7bbD=sym(zeros(N,N));
Vmax1ccA=sym(zeros(N,N));
Vmax1ccB=sym(zeros(N,N));
Vmax1ccC=sym(zeros(N,N));
Vmax1ccD=sym(zeros(N,N));
Vmax2ccA=sym(zeros(N,N));
Vmax2ccB=sym(zeros(N,N));
Vmax2ccC=sym(zeros(N,N));
Vmax2ccD=sym(zeros(N,N));
Vmax3ccA=sym(zeros(N,N));
Vmax3ccB=sym(zeros(N,N));
Vmax3ccC=sym(zeros(N,N));
Vmax3ccD=sym(zeros(N,N));
Vmax4ccA=sym(zeros(N,N));
Vmax4ccB=sym(zeros(N,N));
Vmax4ccC=sym(zeros(N,N));
Vmax4ccD=sym(zeros(N,N));
Vmax5ccA=sym(zeros(N,N));
Vmax5ccB=sym(zeros(N,N));
Vmax5ccC=sym(zeros(N,N));
Vmax5ccD=sym(zeros(N,N));
Vmax6ccA=sym(zeros(N,N));
Vmax6ccB=sym(zeros(N,N));
Vmax6ccC=sym(zeros(N,N));
Vmax6ccD=sym(zeros(N,N));
Vmax7ccA=sym(zeros(N,N));
Vmax7ccB=sym(zeros(N,N));
Vmax7ccC=sym(zeros(N,N));
Vmax7ccD=sym(zeros(N,N));
func2_1A_cell=cell(N);
func2_1B_cell=cell(N);
func2_1C_cell=cell(N);
func2_1D_cell=cell(N);
func2_2A_cell=cell(N);
func2_2B_cell=cell(N);
func2_2C_cell=cell(N);
func2_2D_cell=cell(N);
func2_3A_cell=cell(N);
func2_3B_cell=cell(N);
func2_3C_cell=cell(N);
func2_3D_cell=cell(N);
func2_4A_cell=cell(N);
func2_4B_cell=cell(N);
func2_4C_cell=cell(N);
func2_4D_cell=cell(N);
func2_5A_cell=cell(N);
func2_5B_cell=cell(N);
func2_5C_cell=cell(N);
func2_5D_cell=cell(N);
func2_6A_cell=cell(N);
func2_6B_cell=cell(N);
func2_6C_cell=cell(N);
func2_6D_cell=cell(N);
func2_7A_cell=cell(N);
func2_7B_cell=cell(N);
func2_7C_cell=cell(N);
func2_7D_cell=cell(N);
func3_1A_cell=cell(N);
func3_1B_cell=cell(N);
func3_1C_cell=cell(N);
func3_1D_cell=cell(N);
func3_2A_cell=cell(N);
func3_2B_cell=cell(N);
func3_2C_cell=cell(N);
func3_2D_cell=cell(N);
func3_3A_cell=cell(N);
func3_3B_cell=cell(N);
func3_3C_cell=cell(N);
func3_3D_cell=cell(N);
func3_4A_cell=cell(N);
func3_4B_cell=cell(N);
func3_4C_cell=cell(N);
func3_4D_cell=cell(N);
func3_5A_cell=cell(N);
func3_5B_cell=cell(N);
func3_5C_cell=cell(N);
func3_5D_cell=cell(N);
func3_6A_cell=cell(N);
func3_6B_cell=cell(N);
func3_6C_cell=cell(N);
func3_6D_cell=cell(N);
func3_7A_cell=cell(N);
func3_7B_cell=cell(N);
func3_7C_cell=cell(N);
func3_7D_cell=cell(N);
for i=1:N
	row_num(i)=i;
end
parfor j=1:N
...
for v=1:N
	for u=1:N
		...
		% func2_5C_cell{u,v}=eval(['@(x,y)',vectorize(Vmax5bbC(u,v))]);
		% func2_5D_cell{u,v}=eval(['@(x,y)',vectorize(Vmax5bbD(u,v))]);
		% K2_5(u,v)=Ny*(integral2(func2_5A_cell{u,v},0,x0,y_crackline,b,'AbsTol',1e-12,'RelTol',1e-12)+integral2(func2_5B_cell{u,v},0,x0,0,y_crackline,'AbsTol',1e-12,'RelTol',1e-12)+integral2(func2_5C_cell{u,v},x0,a,0,y_crackline,'AbsTol',1e-12,'RelTol',1e-12)+integral2(func2_5D_cell{u,v},x0,a,y_crackline,b,'AbsTol',1e-12,'RelTol',1e-12));
		% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		% func2_6A_cell{u,v}=eval(['@(x,y)',vectorize(Vmax6bbA(u,v))]);
		% func2_6B_cell{u,v}=eval(['@(x,y)',vectorize(Vmax6bbB(u,v))]);
		% func2_6C_cell{u,v}=eval(['@(x,y)',vectorize(Vmax6bbC(u,v))]);
		% func2_6D_cell{u,v}=eval(['@(x,y)',vectorize(Vmax6bbD(u,v))]);
		% K2_6(u,v)=Nx*(integral2(func2_6A_cell{u,v},0,x0,y_crackline,b,'AbsTol',1e-12,'RelTol',1e-12)+integral2(func2_6B_cell{u,v},0,x0,0,y_crackline,'AbsTol',1e-12,'RelTol',1e-12)+integral2(func2_6C_cell{u,v},x0,a,0,y_crackline,'AbsTol',1e-12,'RelTol',1e-12)+integral2(func2_6D_cell{u,v},x0,a,y_crackline,b,'AbsTol',1e-12,'RelTol',1e-12));
		% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		% func2_7A_cell{u,v}=eval(['@(x,y)',vectorize(Vmax7bbA(u,v))]);
		% func2_7B_cell{u,v}=eval(['@(x,y)',vectorize(Vmax7bbB(u,v))]);
		% func2_7C_cell{u,v}=eval(['@(x,y)',vectorize(Vmax7bbC(u,v))]);
		% func2_7D_cell{u,v}=eval(['@(x,y)',vectorize(Vmax7bbD(u,v))]);
		% K2_7(u,v)=Nxy*(integral2(func2_7A_cell{u,v},0,x0,y_crackline,b,'AbsTol',1e-12,'RelTol',1e-12)+integral2(func2_7B_cell{u,v},0,x0,0,y_crackline,'AbsTol',1e-12,'RelTol',1e-12)+integral2(func2_7C_cell{u,v},x0,a,0,y_crackline,'AbsTol',1e-12,'RelTol',1e-12)+integral2(func2_7D_cell{u,v},x0,a,y_crackline,b,'AbsTol',1e-12,'RelTol',1e-12));
		%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		% func3_5C_cell{u,v}=eval(['@(x,y)',vectorize(Vmax5ccC(u,v))]);
		% func3_5D_cell{u,v}=eval(['@(x,y)',vectorize(Vmax5ccD(u,v))]);
		% K3_5(u,v)=Ny*(integral2(func3_5A_cell{u,v},0,x0,y_crackline,b,'AbsTol',1e-12,'RelTol',1e-12)+integral2(func3_5B_cell{u,v},0,x0,0,y_crackline,'AbsTol',1e-12,'RelTol',1e-12)+integral2(func3_5C_cell{u,v},x0,a,0,y_crackline,'AbsTol',1e-12,'RelTol',1e-12)+integral2(func3_5D_cell{u,v},x0,a,y_crackline,b,'AbsTol',1e-12,'RelTol',1e-12));
		% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		% func3_6A_cell{u,v}=eval(['@(x,y)',vectorize(Vmax6ccA(u,v))]);
		% func3_6B_cell{u,v}=eval(['@(x,y)',vectorize(Vmax6ccB(u,v))]);
		% func3_6C_cell{u,v}=eval(['@(x,y)',vectorize(Vmax6ccC(u,v))]);
		% func3_6D_cell{u,v}=eval(['@(x,y)',vectorize(Vmax6ccD(u,v))]);
		% K3_6(u,v)=Nx*(integral2(func3_6A_cell{u,v},0,x0,y_crackline,b,'AbsTol',1e-12,'RelTol',1e-12)+integral2(func3_6B_cell{u,v},0,x0,0,y_crackline,'AbsTol',1e-12,'RelTol',1e-12)+integral2(func3_6C_cell{u,v},x0,a,0,y_crackline,'AbsTol',1e-12,'RelTol',1e-12)+integral2(func3_6D_cell{u,v},x0,a,y_crackline,b,'AbsTol',1e-12,'RelTol',1e-12));
		% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		% func3_7A_cell{u,v}=eval(['@(x,y)',vectorize(Vmax7ccA(u,v))]);
		% func3_7B_cell{u,v}=eval(['@(x,y)',vectorize(Vmax7ccB(u,v))]);
		% func3_7C_cell{u,v}=eval(['@(x,y)',vectorize(Vmax7ccC(u,v))]);
		% func3_7D_cell{u,v}=eval(['@(x,y)',vectorize(Vmax7ccD(u,v))]);
		% K3_7(u,v)=Nxy*(integral2(func3_7A_cell{u,v},0,x0,y_crackline,b,'AbsTol',1e-12,'RelTol',1e-12)+integral2(func3_7B_cell{u,v},0,x0,0,y_crackline,'AbsTol',1e-12,'RelTol',1e-12)+integral2(func3_7C_cell{u,v},x0,a,0,y_crackline,'AbsTol',1e-12,'RelTol',1e-12)+integral2(func3_7D_cell{u,v},x0,a,y_crackline,b,'AbsTol',1e-12,'RelTol',1e-12));
	end
end
K2=K2_1+K2_2+K2_3+K2_4+K2_5+K2_6+K2_7;
K3=K3_1+K3_2+K3_3+K3_4+K3_5+K3_6+K3_7;
K(1:I^2,1:I^2)=K1;
K(I^2+1:I^2+N,I^2+1:I^2+N)=K2;
K(I^2+N+1:I^2+2*N,I^2+N+1:I^2+2*N)=K3;
toc
tic
%%%%%%%%%%%%%%%%%%% stiffness matrix %%%%%%%%%%%%%%%%%%%
...
K13_7C=zeros(I^2,N);
K13_7D=zeros(I^2,N);
Vmax1abA=sym(zeros(I^2,N));
Vmax1abB=sym(zeros(I^2,N));
Vmax1abC=sym(zeros(I^2,N));
Vmax1abD=sym(zeros(I^2,N));
Vmax2abA=sym(zeros(I^2,N));
Vmax2abB=sym(zeros(I^2,N));
Vmax2abC=sym(zeros(I^2,N));
Vmax2abD=sym(zeros(I^2,N));
Vmax3abA=sym(zeros(I^2,N));
Vmax3abB=sym(zeros(I^2,N));
Vmax3abC=sym(zeros(I^2,N));
Vmax3abD=sym(zeros(I^2,N));
Vmax4abA=sym(zeros(I^2,N));
Vmax4abB=sym(zeros(I^2,N));
Vmax4abC=sym(zeros(I^2,N));
Vmax4abD=sym(zeros(I^2,N));
Vmax5abA=sym(zeros(I^2,N));
Vmax5abB=sym(zeros(I^2,N));
Vmax5abC=sym(zeros(I^2,N));
Vmax5abD=sym(zeros(I^2,N));
Vmax6abA=sym(zeros(I^2,N));
Vmax6abB=sym(zeros(I^2,N));
Vmax6abC=sym(zeros(I^2,N));
Vmax6abD=sym(zeros(I^2,N));
Vmax7abA=sym(zeros(I^2,N));
Vmax7abB=sym(zeros(I^2,N));
Vmax7abC=sym(zeros(I^2,N));
Vmax7abD=sym(zeros(I^2,N));
Vmax1acA=sym(zeros(I^2,N));
Vmax1acB=sym(zeros(I^2,N));
Vmax1acC=sym(zeros(I^2,N));
Vmax1acD=sym(zeros(I^2,N));
Vmax2acA=sym(zeros(I^2,N));
Vmax2acB=sym(zeros(I^2,N));
Vmax2acC=sym(zeros(I^2,N));
Vmax2acD=sym(zeros(I^2,N));
Vmax3acA=sym(zeros(I^2,N));
Vmax3acB=sym(zeros(I^2,N));
Vmax3acC=sym(zeros(I^2,N));
Vmax3acD=sym(zeros(I^2,N));
Vmax4acA=sym(zeros(I^2,N));
Vmax4acB=sym(zeros(I^2,N));
Vmax4acC=sym(zeros(I^2,N));
Vmax4acD=sym(zeros(I^2,N));
Vmax5acA=sym(zeros(I^2,N));
Vmax5acB=sym(zeros(I^2,N));
Vmax5acC=sym(zeros(I^2,N));
Vmax5acD=sym(zeros(I^2,N));
Vmax6acA=sym(zeros(I^2,N));
Vmax6acB=sym(zeros(I^2,N));
Vmax6acC=sym(zeros(I^2,N));
Vmax6acD=sym(zeros(I^2,N));
Vmax7acA=sym(zeros(I^2,N));
Vmax7acB=sym(zeros(I^2,N));
Vmax7acC=sym(zeros(I^2,N));
Vmax7acD=sym(zeros(I^2,N));
func12_1A_cell=cell(I^2,N);
func12_1B_cell=cell(I^2,N);
func12_1C_cell=cell(I^2,N);
func12_1D_cell=cell(I^2,N);
func12_2A_cell=cell(I^2,N);
func12_2B_cell=cell(I^2,N);
func12_2C_cell=cell(I^2,N);
func12_2D_cell=cell(I^2,N);
func12_3A_cell=cell(I^2,N);
func12_3B_cell=cell(I^2,N);
func12_3C_cell=cell(I^2,N);
func12_3D_cell=cell(I^2,N);
func12_4A_cell=cell(I^2,N);
func12_4B_cell=cell(I^2,N);
func12_4C_cell=cell(I^2,N);
func12_4D_cell=cell(I^2,N);
func12_5A_cell=cell(I^2,N);
func12_5B_cell=cell(I^2,N);
func12_5C_cell=cell(I^2,N);
func12_5D_cell=cell(I^2,N);
func12_6A_cell=cell(I^2,N);
func12_6B_cell=cell(I^2,N);
func12_6C_cell=cell(I^2,N);
func12_6D_cell=cell(I^2,N);
func12_7A_cell=cell(I^2,N);
func12_7B_cell=cell(I^2,N);
func12_7C_cell=cell(I^2,N);
func12_7D_cell=cell(I^2,N);
func13_1A_cell=cell(I^2,N);
func13_1B_cell=cell(I^2,N);
func13_1C_cell=cell(I^2,N);
func13_1D_cell=cell(I^2,N);
func13_2A_cell=cell(I^2,N);
func13_2B_cell=cell(I^2,N);
func13_2C_cell=cell(I^2,N);
func13_2D_cell=cell(I^2,N);
func13_3A_cell=cell(I^2,N);
func13_3B_cell=cell(I^2,N);
func13_3C_cell=cell(I^2,N);
func13_3D_cell=cell(I^2,N);
func13_4A_cell=cell(I^2,N);
func13_4B_cell=cell(I^2,N);
func13_4C_cell=cell(I^2,N);
func13_4D_cell=cell(I^2,N);
func13_5A_cell=cell(I^2,N);
func13_5B_cell=cell(I^2,N);
func13_5C_cell=cell(I^2,N);
func13_5D_cell=cell(I^2,N);
func13_6A_cell=cell(I^2,N);
func13_6B_cell=cell(I^2,N);
func13_6C_cell=cell(I^2,N);
func13_6D_cell=cell(I^2,N);
func13_7A_cell=cell(I^2,N);
func13_7B_cell=cell(I^2,N);
func13_7C_cell=cell(I^2,N);
func13_7D_cell=cell(I^2,N);
parfor k=1:N
	%%%%%%%%%%%%%%%%%%% the expression of the terms of maximum strain energy Vmax (integrand) 
...
for k=1:N
	for u=1:I^2
		...
		% if size(symvar(Vmax5abA(u,k)),2)==2
			% func12_5A_cell{u,k}=eval(['@(x,y)',vectorize(Vmax5abA(u,k))]);
			% K12_5A(u,k)=Ny*integral2(func12_5A_cell{u,k},0,x0,y_crackline,b,'AbsTol',1e-12,'RelTol',1e-12);
		% else
			% K12_5A(u,k)=Ny*int(int(Vmax5abA(u,k),x,0,x0),y,y_crackline,b);
		% end
		% if size(symvar(Vmax5abB(u,k)),2)==2
			% func12_5B_cell{u,k}=eval(['@(x,y)',vectorize(Vmax5abB(u,k))]);
			% K12_5B(u,k)=Ny*integral2(func12_5B_cell{u,k},0,x0,0,y_crackline,'AbsTol',1e-12,'RelTol',1e-12);
		% else
			% K12_5B(u,k)=Ny*int(int(Vmax5abB(u,k),x,0,x0),y,0,y_crackline);
		% end
		% if size(symvar(Vmax5abC(u,k)),2)==2
			% func12_5C_cell{u,k}=eval(['@(x,y)',vectorize(Vmax5abC(u,k))]);
			% K12_5C(u,k)=Ny*integral2(func12_5C_cell{u,k},x0,a,0,y_crackline,'AbsTol',1e-12,'RelTol',1e-12);
		% else
			% K12_5C(u,k)=Ny*int(int(Vmax5abC(u,k),x,x0,a),y,0,y_crackline);
		% end
		% if size(symvar(Vmax5abD(u,k)),2)==2
			% func12_5D_cell{u,k}=eval(['@(x,y)',vectorize(Vmax5abD(u,k))]);
			% K12_5D(u,k)=Ny*integral2(func12_5D_cell{u,k},x0,a,y_crackline,b,'AbsTol',1e-12,'RelTol',1e-12);
		% else
			% K12_5D(u,k)=Ny*int(int(Vmax5abD(u,k),x,x0,a),y,y_crackline,b);
		% end
				%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		% if size(symvar(Vmax6abA(u,k)),2)==2
			% func12_6A_cell{u,k}=eval(['@(x,y)',vectorize(Vmax6abA(u,k))]);
			% K12_6A(u,k)=Nx*integral2(func12_6A_cell{u,k},0,x0,y_crackline,b,'AbsTol',1e-12,'RelTol',1e-12);
		% else
			% K12_6A(u,k)=Nx*int(int(Vmax6abA(u,k),x,0,x0),y,y_crackline,b);
		% end
		% if size(symvar(Vmax6abB(u,k)),2)==2
			% func12_6B_cell{u,k}=eval(['@(x,y)',vectorize(Vmax6abB(u,k))]);
			% K12_6B(u,k)=Nx*integral2(func12_6B_cell{u,k},0,x0,0,y_crackline,'AbsTol',1e-12,'RelTol',1e-12);
		% else
			% K12_6B(u,k)=Nx*int(int(Vmax6abB(u,k),x,0,x0),y,0,y_crackline);
		% end
		% if size(symvar(Vmax6abC(u,k)),2)==2
			% func12_6C_cell{u,k}=eval(['@(x,y)',vectorize(Vmax6abC(u,k))]);
			% K12_6C(u,k)=Nx*integral2(func12_6C_cell{u,k},x0,a,0,y_crackline,'AbsTol',1e-12,'RelTol',1e-12);
		% else
			% K12_6C(u,k)=Nx*int(int(Vmax6abC(u,k),x,x0,a),y,0,y_crackline);
		% end
		% if size(symvar(Vmax6abD(u,k)),2)==2
			% func12_6D_cell{u,k}=eval(['@(x,y)',vectorize(Vmax6abD(u,k))]);
			% K12_6D(u,k)=Nx*integral2(func12_6D_cell{u,k},x0,a,y_crackline,b,'AbsTol',1e-12,'RelTol',1e-12);
		% else
			% K12_6D(u,k)=Nx*int(int(Vmax6abD(u,k),x,x0,a),y,y_crackline,b);
		% end
				%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		% if size(symvar(Vmax7abA(u,k)),2)==2
			% func12_7A_cell{u,k}=eval(['@(x,y)',vectorize(Vmax7abA(u,k))]);
			% K12_7A(u,k)=Nxy*integral2(func12_7A_cell{u,k},0,x0,y_crackline,b,'AbsTol',1e-12,'RelTol',1e-12);
		% else
			% K12_7A(u,k)=Nxy*int(int(Vmax7abA(u,k),x,0,x0),y,y_crackline,b);
		% end
		% if size(symvar(Vmax7abB(u,k)),2)==2
			% func12_7B_cell{u,k}=eval(['@(x,y)',vectorize(Vmax7abB(u,k))]);
			% K12_7B(u,k)=Nxy*integral2(func12_7B_cell{u,k},0,x0,0,y_crackline,'AbsTol',1e-12,'RelTol',1e-12);
		% else
			% K12_7B(u,k)=Nxy*int(int(Vmax7abB(u,k),x,0,x0),y,0,y_crackline);
		% end
		% if size(symvar(Vmax7abC(u,k)),2)==2
			% func12_7C_cell{u,k}=eval(['@(x,y)',vectorize(Vmax7abC(u,k))]);
			% K12_7C(u,k)=Nxy*integral2(func12_7C_cell{u,k},x0,a,0,y_crackline,'AbsTol',1e-12,'RelTol',1e-12);
		% else
			% K12_7C(u,k)=Nxy*int(int(Vmax7abC(u,k),x,x0,a),y,0,y_crackline);
		% end
		% if size(symvar(Vmax7abD(u,k)),2)==2
			% func12_7D_cell{u,k}=eval(['@(x,y)',vectorize(Vmax7abD(u,k))]);
			% K12_7D(u,k)=Nxy*integral2(func12_7D_cell{u,k},x0,a,y_crackline,b,'AbsTol',1e-12,'RelTol',1e-12);
		% else
			% K12_7D(u,k)=Nxy*int(int(Vmax7abD(u,k),x,x0,a),y,y_crackline,b);
		% end
		%%%%%%%%%%%
		%%%%%%%%%%%
		...
		% if size(symvar(Vmax5acA(u,k)),2)==2
			% func13_5A_cell{u,k}=eval(['@(x,y)',vectorize(Vmax5acA(u,k))]);
			% K13_5A(u,k)=Ny*integral2(func13_5A_cell{u,k},0,x0,y_crackline,b,'AbsTol',1e-12,'RelTol',1e-12);
		% else
			% K13_5A(u,k)=Ny*int(int(Vmax5acA(u,k),x,0,x0),y,y_crackline,b);
		% end
		% if size(symvar(Vmax5acB(u,k)),2)==2
			% func13_5B_cell{u,k}=eval(['@(x,y)',vectorize(Vmax5acB(u,k))]);
			% K13_5B(u,k)=Ny*integral2(func13_5B_cell{u,k},0,x0,0,y_crackline,'AbsTol',1e-12,'RelTol',1e-12);
		% else
			% K13_5B(u,k)=Ny*int(int(Vmax5acB(u,k),x,0,x0),y,0,y_crackline);
		% end
		% if size(symvar(Vmax5acC(u,k)),2)==2
			% func13_5C_cell{u,k}=eval(['@(x,y)',vectorize(Vmax5acC(u,k))]);
			% K13_5C(u,k)=Ny*integral2(func13_5C_cell{u,k},x0,a,0,y_crackline,'AbsTol',1e-12,'RelTol',1e-12);
		% else
			% K13_5C(u,k)=Ny*int(int(Vmax5acC(u,k),x,x0,a),y,0,y_crackline);
		% end
		% if size(symvar(Vmax5acD(u,k)),2)==2
			% func13_5D_cell{u,k}=eval(['@(x,y)',vectorize(Vmax5acD(u,k))]);
			% K13_5D(u,k)=Ny*integral2(func13_5D_cell{u,k},x0,a,y_crackline,b,'AbsTol',1e-12,'RelTol',1e-12);
		% else
			% K13_5D(u,k)=Ny*int(int(Vmax5acD(u,k),x,x0,a),y,y_crackline,b);
		% end
		...
		% if size(symvar(Vmax6acA(u,k)),2)==2
			% func13_6A_cell{u,k}=eval(['@(x,y)',vectorize(Vmax6acA(u,k))]);
			% K13_6A(u,k)=Nx*integral2(func13_6A_cell{u,k},0,x0,y_crackline,b,'AbsTol',1e-12,'RelTol',1e-12);
		% else
			% K13_6A(u,k)=Nx*int(int(Vmax6acA(u,k),x,0,x0),y,y_crackline,b);
		% end
		% if size(symvar(Vmax6acB(u,k)),2)==2
			% func13_6B_cell{u,k}=eval(['@(x,y)',vectorize(Vmax6acB(u,k))]);
			% K13_6B(u,k)=Nx*integral2(func13_6B_cell{u,k},0,x0,0,y_crackline,'AbsTol',1e-12,'RelTol',1e-12);
		% else
			% K13_6B(u,k)=Nx*int(int(Vmax6acB(u,k),x,0,x0),y,0,y_crackline);
		% end
		% if size(symvar(Vmax6acC(u,k)),2)==2
			% func13_6C_cell{u,k}=eval(['@(x,y)',vectorize(Vmax6acC(u,k))]);
			% K13_6C(u,k)=Nx*integral2(func13_6C_cell{u,k},x0,a,0,y_crackline,'AbsTol',1e-12,'RelTol',1e-12);
		% else
			% K13_6C(u,k)=Nx*int(int(Vmax6acC(u,k),x,x0,a),y,0,y_crackline);
		% end
		% if size(symvar(Vmax6acD(u,k)),2)==2
			% func13_6D_cell{u,k}=eval(['@(x,y)',vectorize(Vmax6acD(u,k))]);
			% K13_6D(u,k)=Nx*integral2(func13_6D_cell{u,k},x0,a,y_crackline,b,'AbsTol',1e-12,'RelTol',1e-12);
		% else
			% K13_6D(u,k)=Nx*int(int(Vmax6acD(u,k),x,x0,a),y,y_crackline,b);
		% end
		...
		% if size(symvar(Vmax7acA(u,k)),2)==2
			% func13_7A_cell{u,k}=eval(['@(x,y)',vectorize(Vmax7acA(u,k))]);
			% K13_7A(u,k)=Nxy*integral2(func13_7A_cell{u,k},0,x0,y_crackline,b,'AbsTol',1e-12,'RelTol',1e-12);
		% else
			% K13_7A(u,k)=Nxy*int(int(Vmax7acA(u,k),x,0,x0),y,y_crackline,b);
		% end
		% if size(symvar(Vmax7acB(u,k)),2)==2
			% func13_7B_cell{u,k}=eval(['@(x,y)',vectorize(Vmax7acB(u,k))]);
			% K13_7B(u,k)=Nxy*integral2(func13_7B_cell{u,k},0,x0,0,y_crackline,'AbsTol',1e-12,'RelTol',1e-12);
		% else
			% K13_7B(u,k)=Nxy*int(int(Vmax7acB(u,k),x,0,x0),y,0,y_crackline);
		% end
		% if size(symvar(Vmax7acC(u,k)),2)==2
			% func13_7C_cell{u,k}=eval(['@(x,y)',vectorize(Vmax7acC(u,k))]);
			% K13_7C(u,k)=Nxy*integral2(func13_7C_cell{u,k},x0,a,0,y_crackline,'AbsTol',1e-12,'RelTol',1e-12);
		% else
			% K13_7C(u,k)=Nxy*int(int(Vmax7acC(u,k),x,x0,a),y,0,y_crackline);
		% end
		% if size(symvar(Vmax7acD(u,k)),2)==2
			% func13_7D_cell{u,k}=eval(['@(x,y)',vectorize(Vmax7acD(u,k))]);
			% K13_7D(u,k)=Nxy*integral2(func13_7D_cell{u,k},x0,a,y_crackline,b,'AbsTol',1e-12,'RelTol',1e-12);
		% else
			% K13_7D(u,k)=Nxy*int(int(Vmax7acD(u,k),x,x0,a),y,y_crackline,b);
		% end
	end
end
...
K23_6=zeros(N,N);
K23_7=zeros(N,N);
Vmax1bcA=sym(zeros(N,N));
Vmax1bcB=sym(zeros(N,N));
Vmax1bcC=sym(zeros(N,N));
Vmax1bcD=sym(zeros(N,N));
Vmax2bcA=sym(zeros(N,N));
Vmax2bcB=sym(zeros(N,N));
Vmax2bcC=sym(zeros(N,N));
Vmax2bcD=sym(zeros(N,N));
Vmax3bcA=sym(zeros(N,N));
Vmax3bcB=sym(zeros(N,N));
Vmax3bcC=sym(zeros(N,N));
Vmax3bcD=sym(zeros(N,N));
Vmax4bcA=sym(zeros(N,N));
Vmax4bcB=sym(zeros(N,N));
Vmax4bcC=sym(zeros(N,N));
Vmax4bcD=sym(zeros(N,N));
Vmax5bcA=sym(zeros(N,N));
Vmax5bcB=sym(zeros(N,N));
Vmax5bcC=sym(zeros(N,N));
Vmax5bcD=sym(zeros(N,N));
Vmax6bcA=sym(zeros(N,N));
Vmax6bcB=sym(zeros(N,N));
Vmax6bcC=sym(zeros(N,N));
Vmax6bcD=sym(zeros(N,N));
Vmax7bcA=sym(zeros(N,N));
Vmax7bcB=sym(zeros(N,N));
Vmax7bcC=sym(zeros(N,N));
Vmax7bcD=sym(zeros(N,N));
func23_1A_cell=cell(N,N);
func23_1B_cell=cell(N,N);
func23_1C_cell=cell(N,N);
func23_1D_cell=cell(N,N);
func23_2A_cell=cell(N,N);
func23_2B_cell=cell(N,N);
func23_2C_cell=cell(N,N);
func23_2D_cell=cell(N,N);
func23_3A_cell=cell(N,N);
func23_3B_cell=cell(N,N);
func23_3C_cell=cell(N,N);
func23_3D_cell=cell(N,N);
func23_4A_cell=cell(N,N);
func23_4B_cell=cell(N,N);
func23_4C_cell=cell(N,N);
func23_4D_cell=cell(N,N);
func23_5A_cell=cell(N,N);
func23_5B_cell=cell(N,N);
func23_5C_cell=cell(N,N);
func23_5D_cell=cell(N,N);
func23_6A_cell=cell(N,N);
func23_6B_cell=cell(N,N);
func23_6C_cell=cell(N,N);
func23_6D_cell=cell(N,N);
func23_7A_cell=cell(N,N);
func23_7B_cell=cell(N,N);
func23_7C_cell=cell(N,N);
func23_7D_cell=cell(N,N);
parfor j=1:N
	%%%%%%%%%%%%%%%%%%% the expression of the terms of maximum strain energy Vmax (integrand) 
...
for v=1:N
	for u=1:N
		...
		% func23_5C_cell{u,v}=eval(['@(x,y)',vectorize(Vmax5bcC(u,v))]);
		% func23_5D_cell{u,v}=eval(['@(x,y)',vectorize(Vmax5bcD(u,v))]);
		% K23_5(u,v)=Ny*(integral2(func23_5A_cell{u,v},0,x0,y_crackline,b,'AbsTol',1e-12,'RelTol',1e-12)+integral2(func23_5B_cell{u,v},0,x0,0,y_crackline,'AbsTol',1e-12,'RelTol',1e-12)+integral2(func23_5C_cell{u,v},x0,a,0,y_crackline,'AbsTol',1e-12,'RelTol',1e-12)+integral2(func23_5D_cell{u,v},x0,a,y_crackline,b,'AbsTol',1e-12,'RelTol',1e-12));
		% func23_6A_cell{u,v}=eval(['@(x,y)',vectorize(Vmax6bcA(u,v))]);
		% func23_6B_cell{u,v}=eval(['@(x,y)',vectorize(Vmax6bcB(u,v))]);
		% func23_6C_cell{u,v}=eval(['@(x,y)',vectorize(Vmax6bcC(u,v))]);
		% func23_6D_cell{u,v}=eval(['@(x,y)',vectorize(Vmax6bcD(u,v))]);
		% K23_6(u,v)=Nx*(integral2(func23_6A_cell{u,v},0,x0,y_crackline,b,'AbsTol',1e-12,'RelTol',1e-12)+integral2(func23_6B_cell{u,v},0,x0,0,y_crackline,'AbsTol',1e-12,'RelTol',1e-12)+integral2(func23_6C_cell{u,v},x0,a,0,y_crackline,'AbsTol',1e-12,'RelTol',1e-12)+integral2(func23_6D_cell{u,v},x0,a,y_crackline,b,'AbsTol',1e-12,'RelTol',1e-12));
		% func23_7A_cell{u,v}=eval(['@(x,y)',vectorize(Vmax7bcA(u,v))]);
		% func23_7B_cell{u,v}=eval(['@(x,y)',vectorize(Vmax7bcB(u,v))]);
		% func23_7C_cell{u,v}=eval(['@(x,y)',vectorize(Vmax7bcC(u,v))]);
		% func23_7D_cell{u,v}=eval(['@(x,y)',vectorize(Vmax7bcD(u,v))]);
		% K23_7(u,v)=Nxy*(integral2(func23_7A_cell{u,v},0,x0,y_crackline,b,'AbsTol',1e-12,'RelTol',1e-12)+integral2(func23_7B_cell{u,v},0,x0,0,y_crackline,'AbsTol',1e-12,'RelTol',1e-12)+integral2(func23_7C_cell{u,v},x0,a,0,y_crackline,'AbsTol',1e-12,'RelTol',1e-12)+integral2(func23_7D_cell{u,v},x0,a,y_crackline,b,'AbsTol',1e-12,'RelTol',1e-12));
	end
end
K23=K23_1+K23_2+K23_3+K23_4+K23_5+K23_6+K23_7;	
K(1:I^2,I^2+1:I^2+N)=K12;
K(1:I^2,I^2+N+1:I^2+2*N)=K13;
K(I^2+1:I^2+N,I^2+N+1:I^2+2*N)=K23;	
for i=I^2+1:I^2+N
	for j=1:I^2
		K(i,j)=K(j,i);
	end
end
for i=I^2+N+1:I^2+2*N
	for j=1:I^2+N
		K(i,j)=K(j,i);
	end
end
...
M2=zeros(N,N);
M3=zeros(N,N);
M=zeros(I^2+2*N,I^2+2*N);	
TmaxbbA=sym(zeros(N,N));
TmaxbbB=sym(zeros(N,N));
TmaxbbC=sym(zeros(N,N));
TmaxbbD=sym(zeros(N,N));
TmaxccA=sym(zeros(N,N));
TmaxccB=sym(zeros(N,N));
TmaxccC=sym(zeros(N,N));
TmaxccD=sym(zeros(N,N));
func_M2A_cell=cell(N);
func_M2B_cell=cell(N);
func_M2C_cell=cell(N);
func_M2D_cell=cell(N);
func_M3A_cell=cell(N);
func_M3B_cell=cell(N);
func_M3C_cell=cell(N);
func_M3D_cell=cell(N);
for j=1:N
	%%%%%%%%%%%%%%%%%%% differentiation with regard to b(i) and b(j)
...
M(1:I^2,1:I^2)=M1;
M(I^2+1:I^2+N,I^2+1:I^2+N)=M2;
M(I^2+N+1:I^2+2*N,I^2+N+1:I^2+2*N)=M3;
toc
tic
%%%%%%%%%%%%%%%%%%% mass matrix %%%%%%%%%%%%%%%%%%%		
%%%%%%%%%%%%%%%%%%% off-diagonal matrices %%%%%%%%%%%%%%%%%%%	
M12=zeros(I^2,N);
M13=zeros(I^2,N);
TmaxabA=sym(zeros(I^2,N));
TmaxabB=sym(zeros(I^2,N));
TmaxabC=sym(zeros(I^2,N));
TmaxabD=sym(zeros(I^2,N));
TmaxacA=sym(zeros(I^2,N));
TmaxacB=sym(zeros(I^2,N));
TmaxacC=sym(zeros(I^2,N));
TmaxacD=sym(zeros(I^2,N));
func_M12A_cell=cell(I^2,N);
func_M12B_cell=cell(I^2,N);
func_M12C_cell=cell(I^2,N);
func_M12D_cell=cell(I^2,N);
func_M13A_cell=cell(I^2,N);
func_M13B_cell=cell(I^2,N);
func_M13C_cell=cell(I^2,N);
func_M13D_cell=cell(I^2,N);
parfor k=1:N
	%%%%%%%%%%%%%%%%%%% the expression of the terms of maximum kinetic energy function Tmax/Omega.^2 (integrand) 
	%%%%%%%%%%%%%%%%%%% differentiation with regard to a(ij) and b(k)
...
tic
M23=zeros(N,N);
TmaxbcA=sym(zeros(N,N));
TmaxbcB=sym(zeros(N,N));
TmaxbcC=sym(zeros(N,N));
TmaxbcD=sym(zeros(N,N));
func_M23A_cell=cell(N);
func_M23B_cell=cell(N);
func_M23C_cell=cell(N);
func_M23D_cell=cell(N);
parfor j=1:N
	%%%%%%%%%%%%%%%%%%% the expression of the terms of maximum kinetic energy function Tmax/Omega.^2 (integrand) 
	%%%%%%%%%%%%%%%%%%% differentiation with regard to b(i) and c(j)
...
M(1:I^2,I^2+1:I^2+N)=M12;
M(1:I^2,I^2+N+1:I^2+2*N)=M13;
M(I^2+1:I^2+N,I^2+N+1:I^2+2*N)=M23;	
for i=I^2+1:I^2+N
	for j=1:I^2
		M(i,j)=M(j,i);
	end
...
toc
tic
X1=zeros(I^2+2*N,I^2+2*N);	
eigenvalues=zeros(I^2+2*N,I^2+2*N);
		...
		for j=1:size(y_nodes,2)
			...
			if xx<=x0 && yy>=(c+(xx-a)*tan(Alpha))	%if the node is in area A
				...
				for p=1:N
					...
					EVALUATED_FUNCTIONS_2(counter_2)=(xx^ll*(xx-a)^mm*yy^nn*(yy-b)^qq)*((((xx-x0)^2+(yy-y0)^2)^0.5)^((2*p-1)/2+1)*(((2*p-1)/2*(1-nu)+3+nu)/(((2*p-1)/2+1)*(nu-1))*cos(((2*p-1)/2+1)*(atan((yy-y0)/(xx-x0))-Alpha))+cos(((2*p-1)/2-1)*(atan((yy-y0)/(xx-x0))-Alpha))));	%WBC*WSA(p)
				end
				counter_3=0;
				for q=1:N
					counter_3=counter_3+1;
					EVALUATED_FUNCTIONS_3(counter_3)=(xx^ll*(xx-a)^mm*yy^nn*(yy-b)^qq)*((((xx-x0)^2+(yy-y0)^2)^0.5)^((2*q-1)/2+1)*(((2*q-1)/2*(1-nu)-3-nu)/(((2*q-1)/2+1)*(nu-1))*sin(((2*q-1)/2+1)*(atan((yy-y0)/(xx-x0))-Alpha))+sin(((2*q-1)/2-1)*(atan((yy-y0)/(xx-x0))-Alpha))));	%WBC*WAA(p)
				end
			elseif xx<=x0 && yy<(c+(xx-a)*tan(Alpha))	%if the node is in area B
				counter_2=0;
				for p=1:N
					counter_2=counter_2+1;
					EVALUATED_FUNCTIONS_2(counter_2)=(xx^ll*(xx-a)^mm*yy^nn*(yy-b)^qq)*((((xx-x0)^2+(yy-y0)^2)^0.5)^((2*p-1)/2+1)*(((2*p-1)/2*(1-nu)+3+nu)/(((2*p-1)/2+1)*(nu-1))*cos(((2*p-1)/2+1)*(atan((yy-y0)/(xx-x0))-Alpha))+cos(((2*p-1)/2-1)*(atan((yy-y0)/(xx-x0))-Alpha))));
				end
				counter_3=0;
				for q=1:N
					counter_3=counter_3+1;
					EVALUATED_FUNCTIONS_3(counter_3)=(xx^ll*(xx-a)^mm*yy^nn*(yy-b)^qq)*((((xx-x0)^2+(yy-y0)^2)^0.5)^((2*q-1)/2+1)*(((2*q-1)/2*(1-nu)-3-nu)/(((2*q-1)/2+1)*(nu-1))*sin(((2*q-1)/2+1)*(atan((yy-y0)/(xx-x0))-Alpha))+sin(((2*q-1)/2-1)*(atan((yy-y0)/(xx-x0))-Alpha))));
				end
			elseif xx>x0 && yy<=(c+(xx-a)*tan(Alpha))	%if the node is in area C
				counter_2=0;
				for p=1:N
					counter_2=counter_2+1;
					EVALUATED_FUNCTIONS_2(counter_2)=(xx^ll*(xx-a)^mm*yy^nn*(yy-b)^qq)*((((xx-x0)^2+(yy-y0)^2)^0.5)^((2*p-1)/2+1)*(((2*p-1)/2*(1-nu)+3+nu)/(((2*p-1)/2+1)*(nu-1))*cos(((2*p-1)/2+1)*(pi-Alpha+atan((yy-y0)/(xx-x0))))+cos(((2*p-1)/2-1)*(pi-Alpha+atan((yy-y0)/(xx-x0))))));
				end
				counter_3=0;
				for q=1:N
					counter_3=counter_3+1;
					EVALUATED_FUNCTIONS_3(counter_3)=(xx^ll*(xx-a)^mm*yy^nn*(yy-b)^qq)*((((xx-x0)^2+(yy-y0)^2)^0.5)^((2*q-1)/2+1)*(((2*q-1)/2*(1-nu)-3-nu)/(((2*q-1)/2+1)*(nu-1))*sin(((2*q-1)/2+1)*(pi-Alpha+atan((yy-y0)/(xx-x0))))+sin(((2*q-1)/2-1)*(pi-Alpha+atan((yy-y0)/(xx-x0))))));
				end
